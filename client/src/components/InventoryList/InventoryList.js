      ...
      <div>
        <div className="inventory-list">
          <div className="inventory-list__container">
            <h3 className="inventory-list__label inventory-list__label--hidden">
              INVENTORY ITEM
            </h3>
            <Link to={'/inventory/' + id} className="inventory-list__link">
              {itemName}
          ...
          <div className="inventory-list__container">
            ...
            <p
              className={
                itemStatus === 'In Stock'
                  ? 'inventory-list__status inventory-list__status--is'
                  : 'inventory-list__status inventory-list__status--oos'
              }
            >
              {itemStatus}
            </p>
          ...
          <div className="inventory-list__container inventory-list__container--buttons">
            <button
              ...
              className="inventory-list__button btn-openModal"
            >
